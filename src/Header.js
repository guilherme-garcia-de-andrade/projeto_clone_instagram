...
/*cria uma barra de progresso dinamica*/
...
<div className="header">
        ...
        <div className="modalCriarConta">
            ...
            <div onClick={()=>fecharModalCriar()} className="fecharModalCriarConta">X</div>
                <h2>Criar Conta</h2>
        ...
        <div className="modalUpload">
            ...
            <div onClick={()=>fecharModalUpload()} className="fecharModalCriarConta">X</div>
                <h2>Fazer Upload</h2>
